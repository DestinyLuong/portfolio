...
function NavBar() {
    return (
        <div>
            ...
            <div className="pie pie1" onClick={() => document.body.classList.remove('active')}>
            <div className="pie-color pie-color1">
                <svg className="card" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
                    <path
            ...
            <div className="pie pie2" onClick={() => document.body.classList.remove('active')}>
            <div className="pie-color pie-color2">
                <svg className="discount" xmlns="http://www.w3.org/2000/svg" viewBox="-375 377 100 100" width="100" height="100">
                    <path
                        fill="#fff"
            ...
            <div className="pie pie3" onClick={() => document.body.classList.remove('active')}>
            ...
            <div className="title">The circular menu</div>
            <div className="body">
